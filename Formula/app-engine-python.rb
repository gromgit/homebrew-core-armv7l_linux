class AppEnginePython < Formula
  ...
  bottle do
    root_url "https://github.com/gromgit/homebrew-core-armv7l_linux/releases/download/app-engine-python"
    sha256 cellar: :any_skip_relocation, armv7l_linux: "8dbaba8ab465e08c0831a7d3ec23f76ac3fbe57062b976f70e2b29a3b55a9cb3"
  end
