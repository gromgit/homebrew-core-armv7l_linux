class BashCompletionAT2 < Formula
  ...
  bottle do
    root_url "https://github.com/gromgit/homebrew-core-armv7l_linux/releases/download/bash-completion@2"
    sha256 cellar: :any_skip_relocation, armv7l_linux: "c4551dd2b4efcc64fe37febc7471365cba49648a46437972aeb57bb3ca0a3b08"
  end
