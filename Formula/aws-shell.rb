class AwsShell < Formula
  ...
  bottle do
    root_url "https://github.com/gromgit/homebrew-core-armv7l_linux/releases/download/aws-shell"
    sha256 cellar: :any_skip_relocation, armv7l_linux: "f4f795a7b9b1951bf83bccaea15a1786c5e16dee1240420072d163b20360c1ec"
  end

  depends_on "python@3.10"

  resource "awscli" do
    url "https://files.pythonhosted.org/packages/96/30/f584fbc74e4715053ddf542e648059aa6e83921b7d8a35d4e274a66b1493/awscli-1.23.5.tar.gz"
    sha256 "90c62f8628e37a884bb2353ee94cebd0ee9621088d667cb6650c0278a943c6fe"
  end
