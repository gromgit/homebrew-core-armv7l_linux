class Yasm < Formula
  ...
  bottle do
    root_url "https://github.com/gromgit/homebrew-core-armv7l_linux/releases/download/yasm"
    rebuild 2
    sha256 cellar: :any_skip_relocation, armv7l_linux: "cb7d36a6031f00489a72382f60d2359909705953450a1c404b018584afa664ba"
  end
