class Daemonize < Formula
  ...
  bottle do
    root_url "https://github.com/gromgit/homebrew-core-armv7l_linux/releases/download/daemonize"
    sha256 cellar: :any_skip_relocation, armv7l_linux: "a696200181d55337b8360047216ee97b37b53e9455779e9b835c794f7add9be5"
  end
